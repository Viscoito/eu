const translations = {
  pt: {
    ...
    "hero.short":
      "Crio soluções digitais que misturam lógica, estética e interatividade. Um resumo rápido aqui; detalhes nas seções abaixo.",
    "hero.q1": "Código + Criatividade",
    "hero.q1d": "Automação, web apps e arte digital no mesmo fluxo.",
    "hero.q2": "Pesquisa aplicada",
    "hero.q2d": "Estudo antes de construir para reduzir retrabalho.",
    "hero.q3": "Live2D ready",
    "hero.q3d": "Base preparada para integração com Cubism.",
    "about.title": "Sobre mim",
    "about.text1":
      "Desde 2010, integro código e criatividade para criar ferramentas funcionais e experiências visuais de qualidade.",
    "about.text2":
      "Perfil autodidata, adaptação rápida em ambientes remotos e foco em transformar ideias em soluções objetivas.",
    "projects.title": "Projetos em destaque",
    "projects.p1.title": "Bots para comunidades",
    "projects.p1.text":
      "Chatbots para IRC com coleta de dados e melhoria de precisão.",
    "projects.p2.title": "Fluxos com IA",
    "projects.p2.text":
      "Refino de prompts/scripts para acelerar produção criativa e técnica.",
    "projects.p3.title": "Pipeline de arte + Live2D",
    "projects.p3.text":
      "Assets visuais e modelos Live2D com padrão de qualidade.",
    "projects.p4.title": "Sites com visual premium",
    "projects.p4.text":
      "Interfaces fluidas inspiradas na Apple com foco em experiência.",
    "gallery.title": "Galeria de artes",
    "gallery.text": "Galeria maior para ilustrações, concept art e renders.",
    "vtuber.title": "VTuber Live2D",
    "vtuber.text":
      "Integração preparada: se você adicionar um arquivo `assets/live2d/model.model3.json`, o site tenta carregar automaticamente um canvas para interação.",
    "vtuber.statusIdle": "Aguardando modelo Live2D local.",
    "vtuber.statusLoading": "Tentando carregar modelo Live2D...",
    "vtuber.statusMissing":
      "Modelo não encontrado. Adicione assets/live2d/model.model3.json",
    "vtuber.statusReady":
      "Modelo Live2D detectado. Próxima etapa: ligar runtime Cubism.",
    "vtuber.hint":
      "Dica: por limitação de acesso remoto, o repo externo pode falhar; então deixei fallback local pronto.",
  ...
  en: {
    ...
    "contact.text":
      "Let’s talk about freelance, projects, digital art, or Live2D.",
  },
  es: {
    "nav.language": "Idioma",
    ...
    "hero.short":
      "Creo soluciones digitales combinando lógica, estética e interactividad. Resumen aquí; detalles abajo.",
    "hero.q1": "Código + Creatividad",
    "hero.q1d": "Automatización, apps web y arte digital en un flujo.",
    "hero.q2": "Investigación aplicada",
    "hero.q2d": "Investigar antes de construir reduce retrabajo.",
    "hero.q3": "Live2D ready",
    "hero.q3d": "Base lista para integrar Cubism.",
    "about.title": "Sobre mí",
    "about.text1":
      "Desde 2010, combino código y creatividad para crear herramientas funcionales y experiencias visuales.",
    "about.text2":
      "Perfil autodidacta, adaptación rápida en remoto y foco en soluciones prácticas.",
    "projects.title": "Proyectos destacados",
    "projects.p1.title": "Bots para comunidades",
    "projects.p1.text":
      "Chatbots IRC con recolección de datos y mejor precisión.",
    "projects.p2.title": "Flujos con IA",
    "projects.p2.text":
      "Refino de prompts/scripts para acelerar trabajo creativo y técnico.",
    "projects.p3.title": "Pipeline arte + Live2D",
    "projects.p3.text":
      "Assets visuales y modelos Live2D con estándar de calidad.",
    ...
    "gallery.text":
      "Galería más grande para ilustraciones, concept art y renders.",
    "vtuber.title": "VTuber Live2D",
    "vtuber.text":
      "Integración preparada: si agregas `assets/live2d/model.model3.json`, el sitio intentará cargar un canvas automáticamente.",
    ...
    "vtuber.statusReady":
      "Modelo detectado. Próximo paso: conectar runtime Cubism.",
    "vtuber.hint":
      "Tip: el acceso al repositorio externo puede fallar; dejé fallback local listo.",
  ...
  ja: {
    ...
    "hero.short":
      "ロジック・美しさ・インタラクションを組み合わせた制作を行います。ここは要約、下で詳細です。",
    "hero.q1": "コード + 創造性",
    "hero.q1d": "自動化・Web・デジタルアートを一つの流れで。",
    "hero.q2": "応用リサーチ",
    "hero.q2d": "先に調査して手戻りを減らします。",
    "hero.q3": "Live2D ready",
    "hero.q3d": "Cubism統合のための土台を準備済み。",
    "about.title": "自己紹介",
    "about.text1":
      "2010年から、コードと創造性を融合し、機能的なツールと高品質な体験を制作。",
    "about.text2": "独学、リモート適応、実用的な解決に強みがあります。",
    "projects.title": "注目プロジェクト",
    "projects.p1.title": "コミュニティ向けボット",
    "projects.p1.text": "データ収集と精度改善を備えたIRCボット。",
    "projects.p2.title": "AIワークフロー",
    "projects.p2.text": "プロンプト/スクリプト改善で制作を高速化。",
    "projects.p3.title": "アート + Live2D パイプライン",
    "projects.p3.text": "品質基準に沿ったビジュアル資産とLive2D制作。",
    "projects.p4.title": "プレミアムサイト",
    "projects.p4.text": "Apple風の滑らかなUIで体験重視。",
    "gallery.title": "アートギャラリー",
    "gallery.text": "イラスト、コンセプトアート、レンダの大きめギャラリー。",
    "vtuber.title": "VTuber Live2D",
    "vtuber.text":
      "`assets/live2d/model.model3.json` を追加すると、サイトが自動ロードを試みます。",
    "vtuber.statusIdle": "ローカルLive2Dモデル待機中。",
    "vtuber.statusLoading": "Live2Dモデルを読み込み中...",
    "vtuber.statusMissing":
      "モデル未検出。assets/live2d/model.model3.json を追加してください。",
    "vtuber.statusReady": "モデル検出。次はCubismランタイム接続です。",
    "vtuber.hint":
      "外部リポジトリアクセスが失敗する場合があるため、ローカルフォールバックを用意しています。",
    "contact.title": "連絡先",
    "contact.text":
      "フリーランス、プロジェクト、デジタルアート、Live2Dの相談歓迎です。",
  },
};
